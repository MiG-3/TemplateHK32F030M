...
#define GPIO_IOMUX_AF(IOMUX_AF)    (((IOMUX_AF) == GPIOMUX_AF3_TIM1CH3) || ((IOMUX_AF) == GPIOMUX_AF3_TIM1CH1N) || \
																	  ((IOMUX_AF) == GPIOMUX_AF3_TIM1CH4) || ((IOMUX_AF) == GPIOMUX_AF3_TIM1CH2N) || \
																	  ((IOMUX_AF) == GPIOMUX_AF0_SWCLK)   || ((IOMUX_AF) == GPIOMUX_AF0_I2C_SDA) )
